        ...
        <>
            ...
            <div className="flex flex-col  items-center  ">
                <Template>
                    ...
                    <div data-aos="zoom-out" className="h-[425px]  flex justify-center ml-[9vw] sm:ml-[0vw] items-center w-96  sm:w-[100%]  mt-[38px]  rounded-2xl  bg-white ">


                        <div className="text-gray-600 flex ">
                            <form className=" border-2 rounded-2xl " onSubmit={handle}>
